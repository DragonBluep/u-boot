...
# toolchain path
if [ -d ../openwrt*/toolchain-${arch}*/bin ]; then
	Toolchain=$(cd ../openwrt*/toolchain-${arch}*/bin; pwd)'/mipsel-openwrt-linux-'
elif [ -d ../openwrt*/staging_dir/toolchain-${arch}*/bin ]; then
	Toolchain=$(cd ../openwrt*/staging_dir/toolchain-${arch}*/bin; pwd)'/mipsel-openwrt-linux-'
else
